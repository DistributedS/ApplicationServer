 ...
 * Class [MyWebServer]
 * 
 * This is a simple web server, which only implements the GET-method.
 *
 * @author Prof. Dr.-Ing. Wolf-Dieter Otte
 */
public class SimpleWebServer extends GenericServer {

    static String defaultPropertiesFileString = "SimpleWebServer.properties";
    ...
    static {
        try {
            ...
            properties = new PropertyHandler(defaultPropertiesFileString);
            port = Integer.parseInt(properties.getProperty("PORT"));
            documentRoot = properties.getProperty("DOC_ROOT_DIRECTORY");

        } catch (Exception e) {
            System.err.println("Properties file " + defaultPropertiesFileString + " not found, exiting ...");
            System.exit(1);
        }
    ...
    public SimpleWebServer() {
        super(SimpleWebServer.port);
    }

    /**
     * The method <code>processConnection()</code> implements the functionality of the web server.
     */
    ...
    public static void main(String[] args) {
        ...
        (new Thread(new SimpleWebServer())).start();
    }
