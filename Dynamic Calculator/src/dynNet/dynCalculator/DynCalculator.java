...
public class DynCalculator {
    ...
    // Operations cache
    private Hashtable operationsCache = null;

    // field containing the name of the configuration file
    static final private String configurationFile = "DynCalculator.properties";
    ...
    private JTextField firstOperand, secondOperand, resultField;
    private JTextField operationsControl;

    
    /*
     * Constructor
     */
    public DynCalculator() {

        operationsCache = new Hashtable();
        try {
    ...
    public void getResult() {
        ...
        // getting operands
        try {
            firstNumber = Float.valueOf(firstOperand.getText()).floatValue();
            secondNumber = Float.valueOf(secondOperand.getText()).floatValue();
        } catch (Exception e) {
        ...
        try {
            Operation operation = getOperationClass(operationsControl.getText());
     ...
     */
    private Operation getOperationClass(String operationString) throws IOException, UnknownOperationException, ClassNotFoundException, InstantiationException, IllegalAccessException {

        Operation operationObject = null;

        if ((operationObject = (Operation) operationsCache.get(operationString)) == null) {
            ...
            operationObject = (Operation) operationClass.newInstance();
